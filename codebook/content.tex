...
\inputcode{Suffix Array*}{5_String/SA_LCP_becaido.cpp} % test by caido
...
\inputcode{Polynomial Operation}{7_Polynomial/Polynomial_Operation.cpp} % test by Lib-checker (Inv/Exp/Log/Power) of Formal Power Series
...
\inputcode{Binary Search On Fraction*}{9_Else/BinarySearchOnFraction.cpp} % test by ABC 333 G after adjusted to int128
\inputcode{1D1D}{9_Else/1d1d.cpp}
\inputcode{SMAWK}{9_Else/smawk.cpp}
