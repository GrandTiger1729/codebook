...
\inputcode{Number Theory Transform*}{7_Polynomial/NTT_stdabs.cpp} % std_abs verbatim; supply mod/G/N and add/sub/mul/Pow yourself (Pow's exponent must be ll); test by Lib-Checker Convolution
...
\inputcode{Polynomial Operation}{7_Polynomial/Operation_stdabs.cpp} % std_abs verbatim; needs NTT, QuadraticResidue, and fac[]/ifac[] for TaylorShift/SamplingShift; test by Lib-Checker Inv/Exp/Log/Pow/Sqrt of FPS, Polynomial Taylor Shift, Shift of Sampling Points
