...
\inputcode{Number Theory Transform*}{7_Polynomial/Number_Theory_Transform.cpp} % self-contained now (add/sub/mul/pw/inv); test by Lib-Checker Convolution
...
\inputcode{Polynomial Operation}{7_Polynomial/Polynomial_Operation.cpp} % test by Lib-Checker Inv/Exp/Log/Pow/Sqrt of FPS, Polynomial Taylor Shift, Shift of Sampling Points, Kth Term of Linearly Recurrent Sequence; PowerProj by local brute force
