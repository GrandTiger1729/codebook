...
\inputcode{Number Theory Transform*}{7_Polynomial/Number_Theory_Transform.cpp} % defines MOD/RT/MAXN, add/sub/mul/pw/inv and the global ntt; test by Lib-Checker Convolution
...
\inputcode{Polynomial Operation}{7_Polynomial/Polynomial_Operation.cpp} % needs NTT; test by Lib-Checker Inv/Exp/Log/Pow/Sqrt of FPS, Polynomial Taylor Shift, Shift of Sampling Points, Kth Term of Linearly Recurrent Sequence; PowerProj and Evaluate/Interpolate by local brute force
