...
\inputcode{Berlekamp Massey}{6_Math/Berlekamp-Massey.cpp} % test by Lib-Checker Find Linear Recurrence
\subsection{Primes}
...
\inputcode{Polynomial Operation}{7_Polynomial/Polynomial_Operation.cpp} % test by Lib-Checker Inv/Exp/Log/Pow/Sqrt of FPS, Polynomial Taylor Shift, Shift of Sampling Points; PowerProj by local brute force; LinearRecursion is correct but TLEs Kth Term of Linearly Recurrent Sequence
